...
export class ErrorHelper {
	static isJiraCredentialError(error: unknown): boolean {
		...
		const payloadText = ErrorHelper.extractAxiosPayloadText(axiosError).toLowerCase();
	...
	static deriveErrorMessage(error: unknown): string {
	...
	private static extractAxiosPayloadText(error: AxiosError<any>): string {
